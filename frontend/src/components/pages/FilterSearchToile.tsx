...
//         try {
//             let foundMatchingToilets = false;  // フィルタに合うトイレが見つかったかどうか
//             let nextPage = currentPage;  // 現在のページ番号
//             let newToilets: Toilet[] = [];

//             // 条件に合うトイレが見つかるか、すべてのデータが取得されるまでループ
//             while (!foundMatchingToilets && hasMore) {
...
//                 newToilets = response.data.toilets || [];

//                 if (newToilets.length < 10) {
//                     setHasMore(false);  // これ以上データがない場合
//                 }

//                 setOriginalToiletList((prevToilets) => [...prevToilets, ...newToilets]);

//                 // フィルタを適用して該当するトイレをチェック
//                 const filteredToilets = applyFilters(
//                     ref.current?.value || '', 
//                     isTopRated, 
//                     showUniversal, 
//                     selectedCountry, 
//                     [...toiletList, ...newToilets]
//                 );

//                 if (filteredToilets.length > 0) {
//                     setToiletList(filteredToilets);  // 条件に一致するトイレを表示
//                     foundMatchingToilets = true;
//                 } else {
//                     nextPage += 1;  // 次のページを取得
...
//             setCurrentPage((prevPage) => prevPage + 1);  // 次のページへ
//         }
//     };
...
//                                 </SelectTrigger>
//                                 <SelectContent>
//                                     <SelectItem value="All Country">All Country</SelectItem>
